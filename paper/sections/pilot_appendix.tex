...
Table \ref{tab:exploratory-sparse-outcome-audit} retains the preregistered
historical-only and adjusted models. The adjusted specification uses a single
platform indicator and a reference category, which repairs the former exact
alias. It remains a descriptive diagnostic because the 78-case sample has only
twelve institutional-change events and the adjusted effects are
deletion-sensitive.

\input{tables/exploratory_sparse_outcome_audit}
