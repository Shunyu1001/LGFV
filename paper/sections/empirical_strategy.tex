...
\subsection{Reference labels and source traceability}

The reference file contains 94 city-platform cases reviewed by the project
author under the frozen codebook. Each case records a formal event, the
...
78 of the 84 matched cases. Complete-case restriction removes six
low-capacity nominal exits while retaining all twelve institutional-change
events. The inherited full-controls design also contains nine columns with
rank eight because the intercept equals the sum of two exhaustive platform
indicators. More importantly, deleting one observation at a time changes the
sign of the adjusted elite-density coefficient in nine of 78 fits, whereas the
historical-only coefficient changes sign in none of the 84 corresponding fits.
Appendix tables retain the first-pass adjusted specifications for
audit, but the main text does not interpret the rank-deficient estimate as a
journal-ready effect. Contemporary fiscal capacity, debt pressure, land-finance
dependence, province, disclosure quality, platform level, and capital or
sub-provincial status remain alternative explanations rather than established
controls for a causal historical effect.
...
a human reference label. The data therefore do not identify recall,
...
formal event, but 128 still lack verified geography and city-platform scope.
No random draw or independent second-coder round has occurred. The present
paper therefore reports screening coverage and selected-overlap concordance,
not a DSL-corrected outcome distribution or adjusted historical effect.
