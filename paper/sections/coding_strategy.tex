...
312 rows. Of these, 297 are now usable LLM screening observations:
ninety-four gold-standard exit labels, 163 LLM surrogate exit-type labels,
...
outcome sample is narrower: it contains 257 rows, consisting of the
ninety-four gold-standard labels and the 163 LLM surrogate exit-type labels.
...
They correspond to 120 unique issuers because several
...
are treated as consistency checks rather than new observations. Fifty-nine
