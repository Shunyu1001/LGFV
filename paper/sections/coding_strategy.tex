...
cases. The full label file now contains sixty-two validated labels; this
...
sixty-two human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. The current pass screens 193 pending disclosures, produces
79 surrogate disclosure-level labels, and leaves 114 cases unresolved. The
...
public-project functions. They correspond to 56 unique issuers because several
...
or city-platform level. Twenty-nine issuers exactly match issuers that
already appear in the gold-standard label file under different case IDs. These
overlaps are treated as consistency checks rather than new observations. Twenty-seven
