...
cases. The full label file now contains sixty validated labels; this
...
sixty human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. The current pass screens 197 pending disclosures, produces
49 medium-confidence surrogate labels, and leaves 148 cases unresolved. The
...
public-project functions. They correspond to 32 unique issuers because several
...
remaining three non-overlap issuers enter the next human-validation queue. The
