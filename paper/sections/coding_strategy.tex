...
The first Codex screening pass follows this rule conservatively. It keeps the
fifty human-validated labels as gold-standard observations and applies the
codebook only to pending candidates. Among 197 pending cases, the pass produces
two medium-confidence surrogate labels and leaves the remaining cases
unresolved because they either lack source-packet text or lack direct formal
exit or compliance evidence. This is a feature of the design rather than a
failure of automation: the model is allowed to identify source gaps instead of
guessing institutional outcomes from titles or generic disclosure language.
