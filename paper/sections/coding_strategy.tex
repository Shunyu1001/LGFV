...
cases. The full label file now contains fifty-eight validated labels; this
...
fifty-eight human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. After removing four boundary-reviewed packets, the current pass screens 185 pending cases, produces
37 medium-confidence surrogate labels, and leaves 148 cases unresolved. The
...
or city-platform level. Twenty-two of the 23 issuers exactly match issuers that
...
remaining issuer forms the next validation queue. The unresolved cases are
