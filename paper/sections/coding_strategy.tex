...
cases. The full label file now contains fifty validated labels; this
...
The Codex screening pass follows this rule conservatively. It keeps the fifty
human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. Among 197 pending cases, the current pass produces
...
or city-platform level. Twenty of the 32 issuers exactly match issuers that
...
remaining 12 issuers form the next validation queue. The unresolved cases are
