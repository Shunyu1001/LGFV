...
310 rows. Of these, 295 are now usable LLM screening observations:
ninety-four gold-standard exit labels, 130 LLM surrogate exit-type labels,
...
outcome sample is narrower: it contains 224 rows, consisting of the
ninety-four gold-standard labels and the 130 LLM surrogate exit-type labels.
...
public-project functions. They correspond to 97 unique issuers because several
...
are treated as consistency checks rather than new observations. Thirty-six
