...
cases. The full label file now contains sixty-one validated labels; this
...
sixty-one human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. The current pass screens 196 pending disclosures, produces
48 medium-confidence surrogate labels, and leaves 148 cases unresolved. The
...
public-project functions. They correspond to 31 unique issuers because several
...
remaining two non-overlap issuers enter the next human-validation queue. The
