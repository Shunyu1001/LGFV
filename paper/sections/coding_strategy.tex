...
317 rows. Of these, 302 are now usable LLM screening observations:
ninety-four gold-standard exit labels, 168 LLM surrogate exit-type labels,
...
outcome sample is narrower: it contains 262 rows, consisting of the
ninety-four gold-standard labels and the 168 LLM surrogate exit-type labels.
...
They correspond to 123 unique issuers because several
...
are treated as consistency checks rather than new observations. Sixty-two
