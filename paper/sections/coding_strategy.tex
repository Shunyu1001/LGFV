...
controlling owner, and city-platform scope status. At the most recent audit,
128 of the 133 issuers lacked a verified geography and scope record, and exact
joins to the existing city-platform files resolved none of those missing
records. The frame is therefore quarantined. No random validation draw has been
made.
