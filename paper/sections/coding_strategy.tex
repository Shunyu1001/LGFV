...
326 rows. Of these, 311 are now usable LLM screening observations:
ninety-four gold-standard exit labels, 177 LLM surrogate exit-type labels,
...
outcome sample is narrower: it contains 271 rows, consisting of the
ninety-four gold-standard labels and the 177 LLM surrogate exit-type labels.
...
They correspond to 132 unique issuers because several
...
are treated as consistency checks rather than new observations. Seventy-one
