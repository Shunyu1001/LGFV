...
cases. The full label file now contains eighty-five validated labels; this
...
eighty-five human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. The current pass screens 166 pending disclosures, produces
52 surrogate disclosure-level labels, and leaves 114 cases unresolved. The
...
public-project functions. They correspond to 33 unique issuers because several
...
or city-platform level. All 33 issuers now match issuers that
already appear in the gold-standard label file under different case IDs. These
overlaps are treated as consistency checks rather than new observations. No
non-overlap issuer remains in the current human-validation queue. Six
