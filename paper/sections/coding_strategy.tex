...
cases. The full file now contains ninety-four provisional reference labels; this
...
codebook. These are provisional gold outcomes for workflow development, not
human-confirmed or independently double-coded labels. The labels comprise two substantive
...
rate among screen-negative cases. No human coder has yet independently
confirmed the working labels, so the paper does not report an intercoder
statistic or human-validation accuracy.
...
or human-confirmed outcomes. The paper therefore reports the LLM output as a
...
The repository now contains a blinded 94-case human-confirmation packet and a
separate 94-case adjudication template. All human and adjudication fields are
blank: no independent human confirmation or adjudication has occurred. A candidate packet
...
design-based analysis. A human coder, blinded to the LLM output and the working
reference decision, will independently apply the frozen codebook to the
