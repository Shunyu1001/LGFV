...
cases. The full label file now contains seventy-three validated labels; this
...
seventy-three human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. The current pass screens 180 pending disclosures, produces
66 surrogate disclosure-level labels, and leaves 114 cases unresolved. The
...
public-project functions. They correspond to 45 unique issuers because several
...
overlaps are treated as consistency checks rather than new observations. Fourteen
