...
cases. The full label file now contains fifty-one validated labels; this
...
fifty-one human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. Among 196 pending cases, the current pass produces
...
or city-platform level. Twenty-one of the 32 issuers exactly match issuers that
...
remaining 11 issuers form the next validation queue. The unresolved cases are
