...
339 rows. Of these, 324 are now usable LLM screening observations:
ninety-four gold-standard exit labels, 190 LLM surrogate exit-type labels,
thirty-five source packets screened as having no direct formal exit or
...
outcome sample is narrower: it contains 284 rows, consisting of the
ninety-four gold-standard labels and the 190 LLM surrogate exit-type labels.
...
They correspond to 145 unique issuers because several
...
are treated as consistency checks rather than new observations. Eighty-four
