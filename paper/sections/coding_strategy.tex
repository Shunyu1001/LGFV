...
eighty-seven human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. The current pass screens 164 pending disclosures, produces
84 surrogate disclosure-level labels, and leaves 80 cases unresolved. The
...
or city-platform level. Thirty-seven issuers match platforms that
already appear in the gold-standard label file under different case IDs. These
overlaps are treated as consistency checks rather than new observations.
Twenty-seven non-overlap issuers remain in the current human-validation queue. Six
