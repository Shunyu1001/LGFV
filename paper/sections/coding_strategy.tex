...
cases. The full label file now contains fifty-seven validated labels; this
...
fifty-seven human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. After removing four boundary-reviewed packets, the current pass screens 186 pending cases, produces
38 medium-confidence surrogate labels, and leaves 148 cases unresolved. The
...
public-project functions. They correspond to 24 unique issuers because several
...
or city-platform level. Twenty-two of the 24 issuers exactly match issuers that
...
remaining 2 issuers form the next validation queue. The unresolved cases are
not negative outcomes. They either lack source-packet text or lack direct
