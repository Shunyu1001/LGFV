...
cases. The full label file now contains fifty-two validated labels; this
...
fifty-two human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. Among 195 pending cases, the current pass produces
...
or city-platform level. Twenty-two of the 32 issuers exactly match issuers that
...
remaining 10 issuers form the next validation queue. The unresolved cases are
