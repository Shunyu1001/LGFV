...
cases. The full label file now contains fifty-four validated labels; this
...
fifty-four human-validated labels as gold-standard observations and applies the codebook
only to pending candidates. Among 193 pending cases, the current pass produces
...
or city-platform level. Twenty-two of the 30 issuers exactly match issuers that
...
remaining 8 issuers form the next validation queue. The unresolved cases are
