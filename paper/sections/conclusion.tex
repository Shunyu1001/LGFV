...
reference file contains 94 author-reviewed cases, each linked to an event,
...
auditable. They do not substitute for independent coding: no second reviewer
has yet labeled a common subset, and the current cases were not drawn from a
