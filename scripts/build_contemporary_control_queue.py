...
def write_doc(path: Path, city_rows: list[dict[str, str]], platform_rows: list[dict[str, str]]) -> None:
    ...
    with path.open("w", encoding="utf-8") as handle:
        ...
        handle.write(" control units built from the 94 working-reference cases. District or county ")
        ...
        handle.write(" working-reference case rows. Platform administrative level is pre-coded only ")
