...
The first-pass full-controls regression sample now has 58 rows. This is not a
final journal sample. It comes from thirty source-backed city-control units
