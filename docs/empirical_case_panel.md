...
The first-pass full-controls regression sample now has 53 rows. This is not a
final journal sample. It comes from twenty-five source-backed city-control units
