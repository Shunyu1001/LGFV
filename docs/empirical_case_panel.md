...
Ji'an adds a Jiangxi prefecture-level nominal-exit case. GDP, resident
population, GDP per capita, general-budget revenue, fiscal self-sufficiency,
government-fund revenue, and local-government debt balance come from a CSPI
Ratings report based on public materials. General-budget expenditure is
calculated from the reported revenue and fiscal self-sufficiency ratio. The row
adds a Jiangxi comparison with low fiscal self-sufficiency, high statutory debt
pressure, and continuing infrastructure, affordable-housing, land-development,
public-parking, data-center, and industrial-fund functions.
Xuchang adds a Henan interior-prefecture nominal-exit case. GDP, resident
population, GDP per capita, general-budget revenue, fiscal self-sufficiency,
government-fund revenue, and local-government debt balance come from a CCXI
tracking report based on public materials. General-budget expenditure is
calculated from the reported revenue and fiscal self-sufficiency ratio. The row
...
Kunming adds a Yunnan provincial-capital nominal-exit case. GDP, GDP per
capita, general-budget revenue, general-budget expenditure, government-fund
revenue, and local-government debt balance come from a Lianhe Ratings tracking
report based on public materials. Resident population is calculated from the
reported GDP and per-capita GDP. The row adds the first Yunnan comparison, with
moderate fiscal self-sufficiency, high statutory debt pressure, and continuing
transport infrastructure and municipal development functions.
Jingdezhen adds a Jiangxi ceramic-city nominal-exit case. GDP, GDP per capita,
general-budget revenue, fiscal self-sufficiency, government-fund revenue, and
local-government debt balance come from a Dongfang Jincheng tracking report
based on local statistical communiques and budget-execution materials. Resident
population is calculated from the reported GDP and per-capita GDP, and
general-budget expenditure is calculated from the reported revenue and fiscal
self-sufficiency ratio. The row adds a weak-fiscal-self-sufficiency,
very-high-debt, high-government-fund-dependence comparison with continuing
infrastructure, affordable-housing, ceramic-cultural-zone construction, and
operation functions.
Fuzhou, Jiangxi adds another Jiangxi prefecture-level nominal-exit case. GDP,
GDP per capita, general-budget revenue, fiscal self-sufficiency,
government-fund revenue, and local-government debt balance come from a Dongfang
Jincheng tracking report based on local statistical communiques, fiscal final
accounts, and the 2024 budget-execution report. Resident population is
calculated from the reported GDP and per-capita GDP, and general-budget
expenditure is calculated from the reported revenue and fiscal self-sufficiency
ratio. The row adds a low-fiscal-self-sufficiency, high-debt comparison with
continuing infrastructure, water-installation, public-transport, tourism,
asset-injection, fiscal-subsidy, and debt-swap support functions.
Yiyang adds a low historical-capacity Hunan transport-platform nominal-exit
case. GDP, GDP per capita, general-budget revenue, general-budget expenditure,
fiscal self-sufficiency, government-fund revenue, and local-government debt
balance come from a Lianhe Ratings tracking report based on public materials.
Resident population is calculated from the reported GDP and per-capita GDP. The
row adds a weak-fiscal-self-sufficiency, high-debt comparison with continuing
transport-infrastructure construction, highway operation, entrusted
construction, government-subsidy, and asset-support functions.
Jinzhong adds a Shanxi public-utility and industrial-operation platform
nominal-exit case. GDP, GDP per capita, general-budget revenue, general-budget
expenditure, government-fund revenue, and local-government debt balance come
from a Dagong tracking report based on public disclosures. Resident population
is calculated from the reported GDP and per-capita GDP, and fiscal
self-sufficiency is calculated from reported budget revenue and expenditure. The
row adds a moderate-fiscal-self-sufficiency, lower-statutory-debt comparison
with continuing heat-supply, highway-operation, water-supply,
engineering-construction, government-capital-injection, asset-transfer, and
subsidy functions.
Rizhao adds a Shandong coastal city-investment nominal-exit case. GDP,
general-budget revenue, general-budget expenditure, fiscal self-sufficiency,
government-fund revenue, and local-government debt balance come from a Lianhe
Ratings report based on public materials, while resident population comes from
a 2024 statistical-communique reprint. GDP per capita is calculated from the
reported GDP and population. The row adds a relatively high-fiscal-self-sufficiency,
moderate-statutory-debt comparison with continuing infrastructure,
affordable-housing, land-development, water-engineering operation,
asset-injection, special-bond, and subsidy-support functions.
Beijing adds an extremely high historical-capacity capital-city development-zone
nominal-exit case. GDP, resident population, and GDP per capita come from the
official municipal statistical communique. General-budget revenue,
general-budget expenditure, and government-fund revenue come from the official
municipal budget-execution report, and the 2024 year-end local-government debt
balance comes from the municipal finance bureau's debt disclosure. The row adds
a very-high-contemporary-capacity, lower-statutory-debt comparison that keeps the
argument from treating state capacity as mechanically producing substantive
exit.
Zhuzhou adds a low historical-capacity Hunan industrial-city nominal-exit case.
GDP, resident population, GDP per capita, general-budget revenue, and
general-budget expenditure come from the official municipal statistical
communique. The 2024 year-end local-government debt balance comes from a CCXI
tracking report, and the land-finance proxy uses the same report's latest
available source-backed government-fund revenue value from 2023. The row is
