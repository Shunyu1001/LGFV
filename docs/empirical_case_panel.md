...
The first-pass full-controls regression sample now has 61 rows. This is not a
final journal sample. It comes from thirty-three source-backed city-control units
