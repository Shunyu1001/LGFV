...
The first-pass full-controls regression sample now has 66 rows. This is not a
final journal sample. It comes from thirty-eight source-backed city-control units
