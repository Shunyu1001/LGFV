...
The first-pass full-controls regression sample now has 60 rows. This is not a
final journal sample. It comes from thirty-two source-backed city-control units
