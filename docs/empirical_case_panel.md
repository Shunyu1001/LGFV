...
The first-pass full-controls regression sample now has 54 rows. This is not a
final journal sample. It comes from twenty-six source-backed city-control units
