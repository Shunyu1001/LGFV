...
effects, and bond disclosure quality. Only source coverage and city-status
fields are currently populated systematically. Debt, land-finance, fiscal, and
platform-hierarchy controls are retained as explicit collection fields rather
than imputed.
