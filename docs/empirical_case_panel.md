...
The first-pass full-controls regression sample now has 59 rows. This is not a
final journal sample. It comes from thirty-one source-backed city-control units
