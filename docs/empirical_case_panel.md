...
The first-pass full-controls regression sample now has 55 rows. This is not a
final journal sample. It comes from twenty-seven source-backed city-control units
