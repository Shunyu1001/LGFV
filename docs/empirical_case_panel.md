...
The first-pass full-controls regression sample now has 37 rows. This is not a
final journal sample. It comes from thirteen source-backed city-control units
...
public-data compilations. Jiaxing is now included from official statistical
