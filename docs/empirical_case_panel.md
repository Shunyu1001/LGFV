...
The first-pass full-controls regression sample now has 57 rows. This is not a
final journal sample. It comes from twenty-nine source-backed city-control units
