...
The first-pass full-controls regression sample now has 52 rows. This is not a
final journal sample. It comes from twenty-four source-backed city-control units
