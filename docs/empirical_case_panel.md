...
The first-pass full-controls regression sample now has 56 rows. This is not a
final journal sample. It comes from twenty-eight source-backed city-control units
